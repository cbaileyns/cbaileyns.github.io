...
var HTMLskillsStart = "<div class='skill-box'>Skills</div>";
var HTMLskills = "<div class='skill-box'>%data%</div>";
...
var HTMLschoolNote = "<ul id='note'>%data%</ul>";
...
var HTMLonlineClassList = "<em><br>Classes Finished</em>";
var HTMLonlineClasses = "<ul id='note'>%data%</ul>";
var HTMLonlineClass = "<li><a href='#'>%data%</a></li>";

var internationalizeButton = "<button id='intbutt'>Internationalize</button>";
